...
alias commit_nixos='git -C ~/git/nixos-config add . && git -C ~/git/nixos-config commit -am "$(date)" && git -C ~/git/nixos-config push'
alias commit_dot='git -C ~/git/dotfiles add . && git -C ~/git/dotfiles commit -am "$(date)" && git -C ~/git/dotfiles push'
